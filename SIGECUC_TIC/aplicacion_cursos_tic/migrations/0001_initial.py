    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('segundo_nombre', models.CharField(default=b'', max_length=30, blank=True)),
                ('primer_apellido', models.CharField(max_length=40)),
                ('segundo_apellido', models.CharField(max_length=40)),
                ('email', models.EmailField(max_length=75, blank=True)),
                ('telefono', models.CharField(max_length=15)),
                ('direccion', models.CharField(max_length=40)),
                ('estado_civil', models.CharField(default=b'SO', max_length=20, choices=[(b'SO', b'Soltero'), (b'CA', b'Casado'), (b'VIU', b'Viudo')])),
            ],
            options={
